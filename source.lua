...
local themeStyles = {
    ...
    MoonTheme = {
        SchemeColor = Color3.fromRGB(54, 49, 95),
        Background = Color3.fromRGB(28, 36, 51),
        Header = Color3.fromRGB(23, 26, 39),
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(23, 26, 39)
    },
}
local oldTheme = ""
...
function Kavo.CreateLib(kavName, themeList)
    ...
    else if themeList == "MoonTheme" then
        themeList = themeStyles.MoonTheme
    else
